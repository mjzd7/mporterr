          ...
          <div className="service-col">
            <div className="service-item content-box">
              <div className="icon">
                ...
                <a target="_blank" href="https://drive.google.com/file/d/1DxZ-JaWgKiRDYvSMnmyr-9AeaSm4ri5J/view?usp=share_link" rel=" noopener noreferrer">
                
                  <span className="mask-lnk name"> <div className="name">Calligraphy</div></span>
                </a>
                Starting to learn calligraphy in childhood from my sister, I have developed keen interest in calligraphy now the skill to a experiment on <a target="_blank" href="https://photos.app.goo.gl/eUdu7NsKjjvuKCA39" rel="noopener noreferrer" >bigger canvases.</a>
            </div>
          </div>
          </div>
        </div>
